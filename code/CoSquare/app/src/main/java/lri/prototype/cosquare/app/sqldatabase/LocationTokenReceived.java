 ...
 */
public class LocationTokenReceived implements BaseColumns {

    private static final String TAG = "LOCATIONTOKENRECEIVED";

    private static final String COMMA_SEP = ",";
    public static final String TABLE_NAME = "locationtokenreceived";
    ...
    public LocationTokenReceived(Context context){
