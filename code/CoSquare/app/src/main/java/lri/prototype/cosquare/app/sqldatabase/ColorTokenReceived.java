 ...
 */
public class ColorTokenReceived implements BaseColumns {

    private static final String TAG = "COLORTOKENRECEIVED";

    private static final String COMMA_SEP = ",";
    public static final String TABLE_NAME = "colortokenreceived";
    ...
    public ColorTokenReceived(Context context){
